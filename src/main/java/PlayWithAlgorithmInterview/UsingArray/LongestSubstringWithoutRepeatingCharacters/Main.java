package PlayWithAlgorithmInterview.UsingArray.LongestSubstringWithoutRepeatingCharacters;

import java.lang.reflect.Method;
import java.lang.Class;

// 比较这个工程中 Solution1, Solution2, Solution2, Solution4 和 Solution5 的算法运行效率
public class Main {
